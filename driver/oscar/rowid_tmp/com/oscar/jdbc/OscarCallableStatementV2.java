...
implements CallableStatement {
    ...
    public OscarCallableStatementV2(OscarJdbc2Connection connection, String sql) throws SQLException {
    ...
    public BaseResultSet createResultSet(Field[] fields, List tuples, String status, int updateCount, long insertOID) throws SQLException {
        return new OscarResultSetV2(this, fields, tuples, status, updateCount, insertOID, this.fetchSize, this.maxrows);
    }
